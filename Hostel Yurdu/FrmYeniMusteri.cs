...
namespace Hostel_Yurdu
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        {
            MessageBox.Show("Bu Oda Dolu. Kullanmaz yani");
        }

        private void BtnBosOda_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Bu Oda Bos. Kullanabilir :)");
        }
        ...
        private void DtpCikisTarihi_ValueChanged(object sender, EventArgs e)
        {
            ...
            DateTime BuyukTarihi = Convert.ToDateTime(DtpCikisTarihi.Text);

            TimeSpan Sonuc;
            Sonuc = BuyukTarihi - KucukTarihi;
